...
if find_python && [ -f "$PROJECT_DIR/.venv/bin/activate" ]; then # Cela dure 1 minute
...
echo "Erreur: impossible d'exécuter les tests. Ni environnement local compatible, ni Docker disponible." >&2
exit 1
